...
*                         file: Server_CPPCLI_ASMSRC.cpp            *
*                                                            files: *
*                                                          calc.asm *
*                                          Server_CPPCLI_ASMSRC.cpp *
*                                                                   *
*                                                 *extended version *
*********************************************************************/
...
namespace Server_CPPCLI_ASMSRC {
    #pragma unmanaged
	extern "C" float calc(double b2, float c1, double d2, float e1, double f2);

	#pragma managed
	public ref class Server_CPPCLI_ASMSRC{
...
{
	float x = Server_CPPCLI_ASMSRC::calc(1, 1, 1, 1, 1);
	Server_CPPCLI_ASMSRC::Server_CPPCLI_ASMSRC::Main(args);
	return 0;
}
